...
const Map<AppLang, Map<String, String>> appStrings = {
  AppLang.tk: {
    ...
    'licenses_thanks_desc': 'Bu programma Flutter we açyk çeşme jemgyýetiniň ajaýyp paketleri esasynda guruldy.',
    'licenses_search': 'Paket gözle…',
    'licenses_packages': 'paket',
    'licenses_not_found': 'Paket tapylmady',
    'profile_feedback_title': 'Pikir ibermek',
    'profile_feedback_desc': 'Soraglaryňyz ýa-da teklipleriňiz bar bolsa, Telegram bot arkaly habarlaşyň. Biz hökman jogap bereris!',
    'profile_feedback_open': 'Telegram aç',
    'profile_feedback_error': 'Telegram açylmady',
    'profile_emoji_hint': 'Saňa ýaraýan emojini saýla. Profil suratyň ýerine görkeziler.',
    ...
    'import_howto': 'Köne telefonyňyzda «Eksport» basyň, teksti göçüriň we şu ýere goýuň.',
  ...
  AppLang.ru: {
    ...
    'licenses_thanks_desc': 'Приложение создано благодаря Flutter и замечательным пакетам open-source сообщества.',
    ...
    'profile_feedback_desc': 'Есть вопросы или предложения? Напишите нам через Telegram бот. Мы обязательно ответим!',
    'profile_feedback_open': 'Открыть Telegram',
    'profile_feedback_error': 'Не удалось открыть Telegram',
    'profile_emoji_hint': 'Выбери эмодзи, который будет отображаться вместо фото в профиле.',
    ...
    'import_howto': 'На старом телефоне нажмите «Экспорт», скопируйте текст и вставьте сюда.',
  ...
  AppLang.en: {
    ...
    'licenses_thanks_desc': 'This app is built thanks to Flutter and the amazing open-source community packages.',
    ...
    'profile_feedback_desc': 'Have questions or suggestions? Contact us via Telegram bot. We will definitely respond!',
    'profile_feedback_open': 'Open Telegram',
    'profile_feedback_error': 'Could not open Telegram',
    'profile_emoji_hint': 'Choose an emoji that will be displayed instead of your profile photo.',
    ...
    'import_howto': 'On the old phone tap "Export", copy the text and paste it here.',
