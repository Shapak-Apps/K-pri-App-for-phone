...
- 🔵 **Оффлайн-приоритет** — разговорник, история, избранное, XP и статистика работают **полностью без интернета**; туркменский ↔ русский и туркменский ↔ английский имеют встроенный оффлайн-словарь; перевод текста для остальных пар языков использует онлайн-сервисы (Google Translate, Lingva, MyMemory) — текст передаётся на их серверы
