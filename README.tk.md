...
Köpri — Flutter-da ýasalan mugt, oflaýn-ileri terjimeçi. Gepleşik kitaby, taryh, halanlar, XP we statistika doly internetsiz işleýär. Rus → türkmen we iňlis → türkmen tekst terjimesi hem oflaýn, içki sözlük arkaly işleýär. Beýleki dil jüpleri üçin programma onlaýn hyzmatlar (Google Translate, Lingva, MyMemory) arkaly işleýär — tekst olara iberilýär. Kamera terjimesi işjeň işlenip düzülýär we v2.0.0 wersiýasynda çykar.
...
- 🔵 **Oflaýn-ileri** — gepleşik kitaby, taryh, halanlar, XP we statistika **doly oflaýndyr**; rus → türkmen we iňlis → türkmen tekst terjimesi hem oflaýn, içki sözlük arkaly işleýär; beýleki dil jüpleri üçin tekst terjimesi onlaýn hyzmatlar (Google Translate, Lingva, MyMemory) arkaly işleýär — tekst olara iberilýär
